...
public class UserController {
	...
	@Autowired
	private ICropInformService cropInformService;
	...
	public ResponseEntity<?> registerUser(@RequestBody Users user) throws CustomerHandlingException {
		System.out.println("In  new user Register");
		try {
			return new ResponseEntity<>(userService.registerOrEditUser(user), HttpStatus.CREATED);
			// Created success status response code indicates that the request has succeeded
